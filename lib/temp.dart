...
class _UnicornDialer extends State<UnicornDialer>
  ...
  Widget build(BuildContext context) {
    ...
    // Don't know the function of the following code
    ...
    // Return an animated transform floating button whose child is an animated
    // transform Icon
    ...
    if (hasChildButtons) {
      ...
      var childButtonsList = widget.childButtons == null ||
          ...
          : List.generate(widget.childButtons.length, (index) {
              ...
              Widget childFAB = FloatingActionButton(
                  onPressed: () {
                ...
                child: Row(children: [
                  ScaleTransition(
                      ...
                      child: (!widget.childButtons[index].hasLabel) ||
                          ...
                          : GestureDetector(
                              onTap: () {
                                if (widget.childButtons[index].currentButton
                                        .onPressed !=
                                    null) {
      ...
      Widget unicornDialWidget = Container(
